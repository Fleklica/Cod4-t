...
<form action="update.php" method="post">
    Ime clana:<br>
    <input type="text" name="Ime_clana" value="<?php echo($tim['Ime_clana']); ?>"><br>
    Prezime clana:<br>
    <input type="text" name="Prezime_clana" value="<?php echo($tim['Prezime_clana']); ?>"><br>
    uloga:<br>
    <input type="text" name="uloga" value="<?php echo($tim['uloga']); ?>"><br>
    Ime ekipe:<br>
    <input type="text" name="Ime_ekipe" value="<?php echo($tim['Ime_ekipe']); ?>"><br>
